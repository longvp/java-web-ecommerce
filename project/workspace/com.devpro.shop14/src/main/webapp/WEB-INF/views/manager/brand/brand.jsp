                ...
                <main>
                    <div class="container p-5">
                    	...
                    	<div class="row ml-2 mb-3">
                    		<a class="btn btn-primary" href="/admin/add-brand">
								    ...
								    <tbody>
										 <c:forEach var="item" items="${brands }">
										 	<tr>
										        ...
										        <td>
										        	<a title="Edit" href="/admin/edit-brand/${item.id}" class="btn btn-primary"><i class="fas fa-edit"></i></a>
										        	<a title="Delete" class="btn btn-danger btn-delete" href="#"><i class="fas fa-trash-alt"></i></a>
										        	<%-- /admin/delete-brand/${item.id} --%>
										        </td>
									       </tr>
										 </c:forEach>
								    </tbody>
