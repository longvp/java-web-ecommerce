                ...
                <main>
                    <div class="container p-5">
                    	...
                    	<div class="row ml-2 mb-3">
                    		<a class="btn btn-primary" href="/admin/add-contact">
								    ...
								    <tbody>
										 <c:forEach var="item" items="${contacts }">
										 	<tr>
										        ...
										        <td>${item.message }</td>
										        <td>
										        	<a title="Edit" href="/admin/edit-contact/${item.id}" class="btn btn-primary"><i class="fas fa-edit"></i></a>
        ...
        <script type="text/javascript">
	        $(document).ready(function(){
	        	...
	        	$(".btn-delete").click(function(event){
	        		...
	        		var id = parseInt(ID);
	        		if(conf == true){
	        			window.location.href = "/admin/delete-contact/" + id;
	        		}
	        	})
